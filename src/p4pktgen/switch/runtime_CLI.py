...
def handle_bad_input_mc(f):
    ...
    def handle(*args, **kwargs):
        ...
        try:
            ...
            raise Exception(str(error))  # CHANGE_FROM_ORIGINAL
    return handle
